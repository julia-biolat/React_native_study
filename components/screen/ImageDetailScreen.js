...
export const ImageDetailScreen = (props)=>{
    ...
    const onPressDownload = useCallback(async()=>{
        ...
        try{
            ...
            const permissionResult = await MediaLibrary.getPermissionsAsync(true); //커미션에 대한 상태 가져옴
            ...
            const asset = await MediaLibrary.createAssetAsync(uri); //url은 위에서 다운 받은 url
